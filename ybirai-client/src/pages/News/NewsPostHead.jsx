...
const NewsHead = () => {
  ...
  return (
    <div className="relative h-[5rem] md:h-[15rem] flex flex-col md:flex-row items-center justify-between w-full bg-gradient-to-b from-blue-500 to-blue-700 p-4 md:p-8">
      ...
      {icons.map((icon, index) => (
        <img
          key={index}
          src={icon.src}
          alt={t('news.header.decorativeIcon', { number: index + 1 })}
